    ...
    <view class="yuyue">
        ...
        <view class="content">
            ...
            <view class="list models">
                ...
                <input class="select" pattern="[0-9]*" placeholder="请输入11位手机号码" v-model="phoneNum" maxlength="11" />
            </view>
            <view class="list models">
                <view class="list-title">验证码</view>
                <input class="select" placeholder="请输入验证码" v-model="codeNum" />
            ...
            <view class="btn-area">
                ...
                <button class="btn" @tap="yuYue">立即预约</button>
